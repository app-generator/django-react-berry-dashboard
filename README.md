# [Django React Berry](https://appseed.us/product/django-react-berry-dashboard) `full-stack`

Full-Stack Seed project generated by **[React App Generator](https://appseed.us/generator/react/)** top of *[Berry Dashboard](https://appseed.us/product/django-react-berry-dashboard)* design. The backend logic is provided by a simple, `easy-to-extend` API Server that manages the Authentication flow (login, registration, logout) using `JSON Web Tokens` (JWT).
...
---
**[Django React Berry](https://appseed.us/product/django-react-berry-dashboard)** - `Full-Stack` Seed project generated by **[AppSeed](https://appseed.us)**.
